            ...
            child: NotificationListener<ScrollNotification>(
              ...
              child: SingleChildScrollView(
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                    columnSpacing: 50, // Adjust space between columns
                    // headingRowHeight: 60, // Adjust heading row height

                    // dataRowHeight: 60, // Adjust data row height
                      ...
                      return DataRow(cells: [
                        ...
                        DataCell(
                          InkWell(
                            onTap: () {
                              if (!user["IsVerify"]) {
                                updateStatus(user["_id"], "IsRejected",
                                    !user["IsRejected"]);
                              } else {
                                showSnackbar(
                        ...
                        DataCell(
                          InkWell(
                            onTap: () {
                              if (user["IsVerify"]) {
                                updateStatus(user["_id"], "IsComleted",
                                    !user["IsComleted"]);
                              } else {
                                showSnackbar(
