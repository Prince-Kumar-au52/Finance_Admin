...
class CompleteWithdrawalScreen extends StatefulWidget {
  @override
  _CompleteWithdrawalScreenState createState() =>
      _CompleteWithdrawalScreenState();
}

class _CompleteWithdrawalScreenState extends State<CompleteWithdrawalScreen> {
  ...
  Future<void> fetchData(int page, int size) async {
    try {
      var url = Uri.parse(
          'http://localhost:5000/v1/withDrow/allWithdrow?page=$page&pageSize=$size&type=completed');
