...
class RejectedWithdrawalScreen extends StatefulWidget {
  @override
  _RejectedWithdrawalScreenState createState() =>
      _RejectedWithdrawalScreenState();
}

class _RejectedWithdrawalScreenState extends State<RejectedWithdrawalScreen> {
  ...
  Future<void> fetchData(int page, int size) async {
    try {
      var url = Uri.parse(
          'http://localhost:5000/v1/withDrow/allWithdrow?page=$page&pageSize=$size&type=rejected');
